		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="<?php echo base_url(); ?>codeigniter">
						<div class="parent-icon"><i class='bx bx-home-circle'></i>
						</div>
				...
				<li>
					<a href="<?php echo base_url(); ?>sliders">
						...
						<div class="menu-title">Sliderler</div>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo base_url(); ?>comments">
						...
						<div class="menu-title">Yorumlar</div>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url(); ?>brands">
						...
						<div class="menu-title">Referanslar</div>
					</a>
				</li>
				...
				<li>
					<a href="<?php echo base_url(); ?>albums">
						...
						<div class="menu-title">Albümler</div>
					</a>
				</li>
